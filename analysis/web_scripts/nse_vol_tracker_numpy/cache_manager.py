...
from data_processor import (
    CACHE_FIELDS,
    VOL_CUMUL, LTP_F, VOL, VOL_SLOW, VOL_FAST, NFIELDS,
...
class CacheManager:
    ...
    def _load_csv_files(self, data_dir, incremental):
        ...
        vol, rma_fast, rma_slow = post_process(
            vcum, from_index, total, odi_min,
            seed_rma_fast=sv_rf, seed_rma_slow=sv_rs, seed_slot=slot)
        ...
        if incremental:
            ...
            if total < from_idx:
                return {'sym_list': sym_list, 'vcum': None, 'vltp': None,
                        'vol': None, 'rma_fast': None, 'rma_slow': None,
